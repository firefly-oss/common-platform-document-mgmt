...
public interface SignatureRequestService {
     ...
     */
    Mono<SignatureRequestDTO> getById(Long id);
     ...
     */
    Flux<SignatureRequestDTO> getByDocumentSignatureId(Long documentSignatureId);
     ...
     * @return A Mono emitting the updated signature request
     */
    Mono<SignatureRequestDTO> sendNotification(Long id);
